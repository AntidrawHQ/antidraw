    ...
    <div className="flex h-full w-full items-start justify-center bg-neutral-800 p-6 pt-16 cursor-default antialiased">
      <div className="flex flex-col max-w-[540px] w-full">
        ...
        <button
          ...
          className="mt-12 w-fit flex items-center justify-center gap-2 py-3 px-5 rounded-[10px] border border-white/12 bg-[rgba(255,255,255,0.08)] text-[#ccc] text-sm font-medium cursor-pointer transition-all duration-200 ease-out hover:bg-[rgba(255,255,255,0.12)] hover:border-white/24"
        >
